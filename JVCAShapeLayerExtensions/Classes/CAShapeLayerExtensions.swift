public extension CAShapeLayer {
    func animateFillColor(color: CGColor, duration: TimeInterval, delay: TimeInterval? = nil) {
    ...
    func animateStrokeColor(color: CGColor, duration: TimeInterval, delay: TimeInterval? = nil) {
